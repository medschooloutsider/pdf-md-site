...
Document mode: `Heavy Audit`
OCR language requested: `automatic` `[]`
OCR language effective: `automatic` `[]`
Page routing: `5 text-layer-plus-image-OCR page(s), 3 OCR page(s)`
Audit sidecars: `Also writes `stem.audit.json`, `stem.audit.html`, and `stem.assets/`.`
Pages: `8`
Generated: `2026-05-08T21:44:41Z`
